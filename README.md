...
[![codecov](https://codecov.io/gh/tomereli/fastapi_example/branch/main/graph/badge.svg?token=fastapi_example_token_here)](https://codecov.io/gh/tomereli/fastapi_example)
[![CI](https://github.com/tomereli/fastapi_example/actions/workflows/main.yml/badge.svg)](https://github.com/tomereli/fastapi_example/actions/workflows/main.yml)

Awesome fastapi_example created by tomereli

## Install

from source
```bash
git clone https://github.com/tomereli/fastapi_example fastapi_example
cd fastapi_example
make install
```
